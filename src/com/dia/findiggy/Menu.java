...
public class Menu extends ListActivity{
	...
	String classes[] = {"TimeValueOfMoney", "MoneyMarket", "MeasuresFEI", "AboutUs"};
	String menulist[] = {"Time Value Of Money", "Money Market", "Measures For Evaluating Investments", "About Us"};
