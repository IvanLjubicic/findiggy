...
public class ContinuousCompounding extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.bInfo:
			for (int i = 0; i < 2; i++)
				 Toast.makeText(this, "The process of earning interest on top of interest. The interest is earned constantly, and immediately begins earning interest on itself.",Toast.LENGTH_LONG).show();
			break;
		}
	}
